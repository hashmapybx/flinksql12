 ...
 *
 * 案例- 从Kafka:input_kafka主题消费数据并生成Table,然后过滤出状态为success的数据再写回到Kafka:output_kafka主题
 */
public class TableFromKafka {
    public static void main(String[] args) throws Exception {
        ...
        TableResult inputTable = tenv.executeSql(
                "CREATE TABLE input_kafka (\n" +
                        ...
                        "  'connector' = 'kafka',\n" +
                        "  'topic' = 'input_kafka',\n" +
                        "  'properties.bootstrap.servers' = '47.116.75.250:9092',\n" +
        ...
        //todo 3.sink
        DataStream<Tuple2<Boolean, Row>> retractStream = tenv.toRetractStream(etlResult, Row.class);
